//use crate::instruction::{Direction, InstructionEnum, InstructionEvent};
...
//pub struct Player;
//
//fn spawn_player(mut commands: Commands, mut states: ResMut<States>, mut ls: ResMut<LineStart>) {
...
//                    player_state.handle_moov(
//                        "north",
//                        &mut curr_location,
//                        &mut commands,
//                        &mut states,
//                        &mut line_start.location,
//                        &mut say_writer,
//                    );
//                }
...
//            _ => {
//                unimplemented!()
//            } // message saying there is no path
//        }
//    }
//}
//
